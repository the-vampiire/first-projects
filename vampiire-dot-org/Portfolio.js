...
// ---- Overview Hover Over Captions ----- //
    ...
    $('#Overview7').hover(function(){
        $('#Overview1Caption7').toggle();

    });

    $('#Overview8').hover(function(){
        $('#Overview1Caption8').toggle();

    });

    $('#Overview9').hover(function(){
        $('#Overview1Caption9').toggle();
...
// Overview Tab Section
    ...
    // Project6 Tab Section
    $('#Calculator-Tab').on('shown.bs.tab', function(){
        $('#Project6-Accordion')[0].scrollIntoView(false);

    });

    // Project7 Tab Section
    $('#Pomodoro-Tab').on('shown.bs.tab', function(){
        $('#Project7-Accordion')[0].scrollIntoView(false);

    });

    // Project8 Tab Section
    $('#TicTacToe-Tab').on('shown.bs.tab', function(){
        $('#Project8-Accordion')[0].scrollIntoView(false);

    });

    // Project9 Tab Section
    $('#Simon-Tab').on('shown.bs.tab', function(){
        $('#Project9-Accordion')[0].scrollIntoView(false);
...
// Project 6
    $('#Project6-Description').on('shown.bs.collapse', function(){
        $(this)[0].scrollIntoView(false);
        $('.down-arrow').removeClass("fa fa-arrow-circle-o-down fa-2x down-arrow").addClass("fa fa-arrow-circle-o-up fa-2x up-arrow")
    });

    $('#Project6-Description').on('hidden.bs.collapse', function(){
        $('#Project6-Accordion')[0].scrollIntoView(false);
        $('.up-arrow').removeClass("fa fa-arrow-circle-o-up fa-2x up-arrow").addClass("fa fa-arrow-circle-o-down fa-2x down-arrow")
    });

// Project 7
$('#Project7-Description').on('shown.bs.collapse', function(){
    $(this)[0].scrollIntoView(false);
    $('.down-arrow').removeClass("fa fa-arrow-circle-o-down fa-2x down-arrow").addClass("fa fa-arrow-circle-o-up fa-2x up-arrow")
});

$('#Project7-Description').on('hidden.bs.collapse', function(){
    $('#Project7-Accordion')[0].scrollIntoView(false);
    $('.up-arrow').removeClass("fa fa-arrow-circle-o-up fa-2x up-arrow").addClass("fa fa-arrow-circle-o-down fa-2x down-arrow")
});

// Project 8
$('#Project8-Description').on('shown.bs.collapse', function(){
    $(this)[0].scrollIntoView(false);
    $('.down-arrow').removeClass("fa fa-arrow-circle-o-down fa-2x down-arrow").addClass("fa fa-arrow-circle-o-up fa-2x up-arrow")
});

$('#Project8-Description').on('hidden.bs.collapse', function(){
    $('#Project8-Accordion')[0].scrollIntoView(false);
    $('.up-arrow').removeClass("fa fa-arrow-circle-o-up fa-2x up-arrow").addClass("fa fa-arrow-circle-o-down fa-2x down-arrow")
});

// Project 9
$('#Project9-Description').on('shown.bs.collapse', function(){
    $(this)[0].scrollIntoView(false);
    $('.down-arrow').removeClass("fa fa-arrow-circle-o-down fa-2x down-arrow").addClass("fa fa-arrow-circle-o-up fa-2x up-arrow")
});

$('#Project9-Description').on('hidden.bs.collapse', function(){
    $('#Project9-Accordion')[0].scrollIntoView(false);
    $('.up-arrow').removeClass("fa fa-arrow-circle-o-up fa-2x up-arrow").addClass("fa fa-arrow-circle-o-down fa-2x down-arrow")
});
